...
class BodyCouponsManagement extends StatefulWidget {
  const BodyCouponsManagement({super.key, required this.userRole});
...
class _BodyCouponsManagementState extends State<BodyCouponsManagement> {
  ...
  Widget build(BuildContext context) {
    return widget.userRole != 'admin'
        ...
        : BlocBuilder<GetAllCouponsCubit, GetAllCouponsState>(
                ...
                return BlocListener<DeleteCouponCubit, DeleteCouponState>(
                  listener: (context, delete) {
                    if (delete is DeleteCouponSuccess) {
                      ...
                      myErrorSnackBar(context, "Loading...");
                    } else {
                      myErrorSnackBar(context, "something has gone wrong");
                    }
                  },
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => AddCouponPage(
                                      ...
                                      couponDiscount:
                                          listCoupons[index].discount!,
                                      couponName: listCoupons[index].name!,
                                      couponExpiration: listCoupons[index]
                                          .expire!
                                          .substring(0, 10),
                                    ),
                                  ),
