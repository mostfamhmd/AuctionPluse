...
class BodyAuctionForUser extends StatelessWidget {
  const BodyAuctionForUser({
    super.key,
    required this.myBid,
  ...
  final TextEditingController myBid;
              ...
              child: Row(
                children: [
                  Expanded(
                    ...
                    hintText:
                        "> ${((auction.baseprice! > auction.increaseBidBy!) ? auction.baseprice : auction.increaseBidBy)} ",
                  )),
                  SizedBox(
                    width: 15.w,
                  ),
                  MySmallBTN(
                    ...
                    onTap: () {
                      context.read<UpdateAuctionCubit>().updateAuction(
                          ...
                          increaseBidBy: int.parse(myBid.text),
                          userID: userID);
                    },
                  ),
                ],
